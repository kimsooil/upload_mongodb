    ...
    <body>
        ...
        <div id="show-restaurant" class="content scaffold-show" role="main">
            ...
            <g:if test="${this.restaurant.featuredImageBytes}">
                <img src="<g:createLink controller="restaurant" action="featuredImage" id="${this.restaurant.id}"/>" width="400"/><br/>
				<a href='<g:createLink controller="restaurant" action="featuredImage" id="${this.restaurant.id}"/>'>Download</a>
            </g:if>
